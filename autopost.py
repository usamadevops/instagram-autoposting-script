...
firebase_credentials = credentials.Certificate({
    ...
    "project_id": os.environ.get("PROJECT_ID") or os.environ["PROJECT_ID"],
    "private_key_id": os.environ.get("PRIVATE_KEY_ID") or os.environ["PRIVATE_KEY_ID"],
    "private_key": os.environ.get("PRIVATE_KEY").replace("\\n", "\n") or os.environ["PRIVATE_KEY"],
    "client_email": os.environ.get("CLIENT_EMAIL") or os.environ["CLIENT_EMAIL"],
    "client_id": os.environ.get("CLIENT_ID") or os.environ["CLIENT_ID"] ,
    "auth_uri": os.environ.get("AUTH_URI") or os.environ["AUTH_URI"],
    "token_uri": os.environ.get("TOKEN_URI") or os.environ["TOKEN_URI"],
    "auth_provider_x509_cert_url": os.environ.get("AUTH_PROVIDER_X509_CERT_URL") or os.environ["AUTH_PROVIDER_X509_CERT_URL"],
    "client_x509_cert_url": os.environ.get("CLIENT_X509_CERT_URL") or os.environ["CLIENT_X509_CERT_URL"],
})
...
def main():
    ...
    interval = 60 * 30 # Post every hour
